...
<Article {date} {text} photos="{pig.photos}" type="graduate">
	<PigProfile {city} {overseer} {graduated} {pig_sex} {pig_status} {pig_status_id} {taken} {rainbow} {pic} {header} {age} {type} {redirect_to_edit} {admin} bind:modal_opened={modal_opened} bind:status_value={status_value} />
</Article>
