                ...
                <div class="additional_description">
                    ...
                    {:else}
                        ...
                        <p>
                            ...
                            а от многих выпускников получаем фото- и видео-приветы, которые выкладываем на стене <a class="link" target="_blank" href="https://vk.com/domiksvinok" rel="nofollow">нашей группы</a>.
                        </p>
                    {/if}
                </div>
            {/if}
